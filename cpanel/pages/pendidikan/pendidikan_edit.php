                  ...
                  <div class="modal-body">
                    <p>
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pendidikan" id="exampleInputEdu1" placeholder="Masukkan tingkatan pendidikan." value="<?php echo $r['pendidikan']; ?>" required="required">
                        </div>
					</p>
					...
					<p>
						...
						<div class="form-group">
							<label>Aktifkan Pendidikan</label>
						</div>
