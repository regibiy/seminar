...
<?php
	...
	$cek_card = mysqli_num_rows(mysqli_query($connect, "SELECT jns_kartuid FROM kartu_identitas
										   WHERE jns_kartuid='$jns_card'"));

	if($cek_card > 0){
		echo" <script>alert('Jenis karu identitas sudah digunakan. Silahkan gunakan nama kartu identitas yang lain.');</script>";
		echo "<meta http-equiv='refresh' content='0;url=?page=adCard'>";
	}
