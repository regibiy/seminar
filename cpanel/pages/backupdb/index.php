          ...
          <div class="box">
			...
			<?php
				if(isset($_POST['backup'])){
					...
					$a = backup_tables("localhost","root","","db_seminar",$file);
			?>

					<p align="center">&nbsp;</p>
						<p align="center"><a style="cursor:pointer" onClick="location.href='../cpanel/pages/backupdb/download_backup_data.php?nama_file=<?php echo $file; ?>'" title="Download">Backup database telah selesai. <font color="#0066FF">Download file database</font></a>
					</p>
