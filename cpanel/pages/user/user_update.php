...
<?php
	...
	/*--------------------------------------------------------------------------*/
		...
		$pass = antiinjection(md5($_POST['passwd']));
		$pass_origin = antiinjection($_POST['passwd']);
		...
		if (empty($lokasi_file)){
			...
			if (trim($hp)=="" or ! is_numeric(trim($hp))) {
				...
				mysqli_query($connect, "UPDATE pengguna SET passwd = '$pass',
										passwd_origin = '$pass_origin',
										nm_lengkap = '$nm_user',
										jns_kelamin = '$_POST[kelamin]',
										alamat_pengguna = '$alamat',
										kota_kab_pengguna = '$kotakab',
										kode_pos_pengguna = '$kodepos',
										email_pengguna = '$email',
										hp_pengguna = '$hp',
										status_pengguna = '$_POST[status_user]',
										blokir = '$_POST[blokir]',
										md_dt_pengguna = '$tgl_sekarang',
										md_tm_pengguna = '$jam_sekarang',
										md_username_pengguna = '$_SESSION[username]'
